...
-(void)showDoughnut3Demo {
    ...
    NSString *doughnut3Json = @"{\"title\":{\"text\":\"你幸福吗？\",\"x\":\"center\",\"y\":\"center\",\"itemGap\":20,\"textStyle\":{\"color\":\"rgba(30,144,255,0.8)\",\"fontFamily\":\"微软雅黑\",\"fontSize\":10,\"fontWeight\":\"bolder\"}},\"tooltip\":{\"show\":true,\"formatter\":\"{a} <br/>{b} : {c} ({d}%)\"},\"legend\":{\"orient\":\"vertical\",\"x\":190,\"y\":32,\"itemGap\":1,\"textStyle\" : {\"fontSize\": 7},\"data\":[\"68%的人表示过的不错\",\"29%的人表示生活压力很大\",\"3%的人表示“我姓曾”\"]},\"toolbox\":{\"show\":true,\"feature\":{\"mark\":{\"show\":true},\"dataView\":{\"show\":true,\"readOnly\":false},\"restore\":{\"show\":true},\"saveAsImage\":{\"show\":true}}},\"series\":[{\"name\":\"1\",\"type\":\"pie\",\"clockWise\":false,\"radius\":[50,62.5],\"data\":[{\"value\":68,\"name\":\"68%的人表示过的不错\"},{\"value\":32,\"name\":\"invisible\"}]},{\"name\":\"2\",\"type\":\"pie\",\"clockWise\":false,\"radius\":[37.5,50],\"data\":[{\"value\":29,\"name\":\"29%的人表示生活压力很大\"},{\"value\":71,\"name\":\"invisible\"}]},{\"name\":\"3\",\"type\":\"pie\",\"clockWise\":false,\"radius\":[25,37.5],\"data\":[{\"value\":3,\"name\":\"3%的人表示“我姓曾”\"},{\"value\":97,\"name\":\"invisible\"}]}]}";
