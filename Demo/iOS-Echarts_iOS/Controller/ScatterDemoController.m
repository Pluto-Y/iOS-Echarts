 ...
 *  类目散点图
 */
- (void)showCategoryScatterDemo {
    NSString *json = @"{\"grid\":{\"x\":25,\"x2\":20},\"title\":{\"text\":\"类目坐标散点图\",\"subtext\":\"dataZoom支持\"},\"tooltip\":{\"trigger\":\"axis\",\"axisPointer\":{\"show\":true,\"type\":\"cross\",\"lineStyle\":{\"type\":\"dashed\",\"width\":1}}},\"toolbox\":{\"show\":true,\"feature\":{\"mark\":{\"show\":true},\"dataView\":{\"show\":true,\"readOnly\":false},\"restore\":{\"show\":true},\"saveAsImage\":{\"show\":true}}},\"dataZoom\":{\"show\":true,\"start\":30,\"end\":70},\"legend\":{\"data\":[\"series1\",\"series2\"]},\"dataRange\":{\"min\":0,\"max\":100,\"orient\":\"horizontal\",\"y\":30,\"x\":\"center\",\"color\":[\"lightgreen\",\"orange\"],\"splitNumber\":5},\"xAxis\":[{\"type\":\"category\",\"axisLabel\":{\"formatter\":\"(function(v) {return \'类目\' + v})\"},\"data\":\"(function (){var list = [];var len = 0;while (len++ < 500) {list.push(len);}return list;})()\"}],\"yAxis\":[{\"type\":\"value\"}],\"animation\":false,\"series\":[{\"name\":\"series1\",\"type\":\"scatter\",\"tooltip\":{\"trigger\":\"item\",\"formatter\":\"( function (params) {return params.seriesName + \' （\'  + \'类目\' + params.value[0] + \'）<br/>\'+ params.value[1] + \', \' + params.value[2]; })\",\"axisPointer\":{\"show\":true}},\"symbolSize\":\"(function (value){return Math.round(value[2]/50);})\",\"data\":\"(function () {var d = [];var len = 0;var value;while (len++ < 500) {d.push([len,(Math.random()*30).toFixed(2) - 0,(Math.random()*100).toFixed(2) - 0]);}return d;})()\"},{\"name\":\"series2\",\"type\":\"scatter\",\"tooltip\":{\"trigger\":\"item\",\"formatter\":\"(function (params) {return params.seriesName + \' （\'  + \'类目\' + params.value[0] + \'）<br/>\'+ params.value[1] + \', \' + params.value[2]; })\",\"axisPointer\":{\"show\":true}},\"symbolSize\":\"(function (value){return Math.round(value[2]/50);})\",\"data\":\"(function () {var d = [];var len = 0;var value;while (len++ < 500) {d.push([len, (Math.random()*30).toFixed(2) - 0,(Math.random()*100).toFixed(2) - 0]);}return d; })()\"}]}";
    NSData *jsonData = [json dataUsingEncoding:NSUTF8StringEncoding];
    NSDictionary *jsonDic = [NSJSONSerialization JSONObjectWithData:jsonData options:NSJSONReadingAllowFragments error:nil];
    PYOption *option = [RMMapper objectWithClass:[PYOption class] fromDictionary:jsonDic];
    [_kEchartView setOption:option];
 ...
 *  时间坐标
 */
- (void)showTimeDataDemo {
    NSString *json = @"{\"grid\":{\"x\":30,\"x2\":45,\"y2\":30},\"title\":{\"text\":\"时间坐标散点图\",\"subtext\":\"dataZoom支持\"},\"tooltip\":{\"trigger\":\"axis\",\"axisPointer\":{\"show\":true,\"type\":\"cross\",\"lineStyle\":{\"type\":\"dashed\",\"width\":1}}},\"toolbox\":{\"show\":true,\"feature\":{\"mark\":{\"show\":true},\"dataView\":{\"show\":true,\"readOnly\":false},\"restore\":{\"show\":true},\"saveAsImage\":{\"show\":true}}},\"dataZoom\":{\"show\":true,\"start\":30,\"end\":70},\"legend\":{\"data\":[\"series1\"]},\"dataRange\":{\"min\":0,\"max\":100,\"orient\":\"horizontal\",\"y\":30,\"x\":\"center\",\"color\":[\"lightgreen\",\"orange\"],\"splitNumber\":5},\"grid\":{\"y2\":80},\"xAxis\":[{\"type\":\"time\",\"splitNumber\":10}],\"yAxis\":[{\"type\":\"value\"}],\"animation\":false,\"series\":[{\"name\":\"series1\",\"type\":\"scatter\",\"tooltip\":{\"trigger\":\"axis\",\"formatter\":\"(function (params) {var date = new Date(params.value[0]);return params.seriesName + \' （\'+ date.getFullYear() + \'-\'+ (date.getMonth() + 1) + \'-\'+ date.getDate() + \' \'+ date.getHours() + \':\'+ date.getMinutes()+  \'）<br/>\'+ params.value[1] + \', \' + params.value[2];})\",\"axisPointer\":{\"type\":\"cross\",\"lineStyle\":{\"type\":\"dashed\",\"width\":1}}},\"symbolSize\":\"(function (value){return Math.round(value[2]/50);})\",\"data\":\"(function () {var d = [];var len = 0;var now = new Date();var value;while (len++ < 1500) {d.push([new Date(2014, 9, 1, 0, Math.round(Math.random()*10000)),(Math.random()*30).toFixed(2) - 0,(Math.random()*100).toFixed(2) - 0]);}return d;})()\"}]}";
    NSData *jsonData = [json dataUsingEncoding:NSUTF8StringEncoding];
    NSDictionary *jsonDic = [NSJSONSerialization JSONObjectWithData:jsonData options:NSJSONReadingAllowFragments error:nil];
    PYOption *option = [RMMapper objectWithClass:[PYOption class] fromDictionary:jsonDic];
    [_kEchartView setOption:option];
